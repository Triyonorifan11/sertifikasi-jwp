...
@section('content')
    ...
    <form action="{{ isset($role->id) ? route('roles.update', $role) : route('roles.store') }}" method="post">
        ...
        <div class="grid grid-cols-12 gap-6 mt-5 box">
            <div class="pt-5 col-span-12 lg:col-span-6">
                <div class="px-5">
                    <div>
                        ...
                        <input id="role_name" type="text" class="form-control w-full" name="role_name"
                            placeholder="Input text" required
                            value="{{ isset($role->role_name) ? $role->role_name : old('role_name') }}" autocomplete="off">
                        @error('role_name')
            ...
            <div class="pt-5 col-span-12 lg:col-span-6">
                <div class="px-5">
                    <div>
                        ...
                        <input id="role_description" type="text" class="form-control w-full" name="role_description"
                            placeholder="Input text" required
                            value="{{ isset($role->role_name) ? $role->role_name : old('role_name') }}" autocomplete="off">
            ...
            <div class="col-span-12 lg:col-span-12">
                <div class="px-5">
                    <div class="form-check mt-4"> <input class="check_all" id="all" class="form-check-input"
                            type="checkbox"> <label class="form-check-label font-bold" for="all">Select All</label>
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-12 lg:col-span-4">
                <div class="px-5">
                    <div class="form-check"> <input class="check_parent_role" id="master" class="form-check-input"
                            type="checkbox"> <label class="form-check-label font-semibold" for="master">Master</label>
                    </div>
            ...
            <div class="col-span-12 lg:col-span-4">
                <div class="px-5">
                    <div class="form-check mt-4"> <input class="check_parent_role" id="transaction" class="form-check-input"
                            type="checkbox"> <label class="form-check-label  font-semibold"
                            for="transaction">Transaction</label> </div>
                    <div class="check-child pl-3">
                        <div class="form-check mt-2"> <input @if (isset($role->purchase_order) ? $role->purchase_order : false) checked @endif
                                id="puchase_order" name="purchase_order" class="form-check-input" type="checkbox"> <label
                                class="form-check-label" for="puchase_order">Purchase Order</label> </div>
                        <div class="form-check mt-2"> <input @if (isset($role->sales_order) ? $role->sales_order : false) checked @endif
                                id="sales_order" name="sales_order" class="form-check-input" type="checkbox"> <label
                                class="form-check-label" for="sales_order">Sales Order</label> </div>
                        <div class="form-check mt-2"> <input @if (isset($role->keranjang) ? $role->keranjang : false) checked @endif
            ...
            <div class="col-span-12 lg:col-span-4 hidden">
                <div class="px-5">
                    <div class="form-check mt-4"> <input class="check_parent_role" id="report"
                            class="form-check-input" type="checkbox"> <label class="form-check-label font-semibold"
                            for="report">Report</label> </div>
                    <div class="check-child pl-3">
                        <div class="form-check mt-2"> <input @if (isset($role->report_purchase_order) ? $role->report_purchase_order : false) checked @endif
                                id="report_purchase_order" name="report_purchase_order" class="form-check-input"
                                type="checkbox"> <label class="form-check-label" for="report_purchase_order">Purchase
                                Order</label> </div>
                        <div class="form-check mt-2"> <input @if (isset($role->report_sales_order) ? $role->report_sales_order : false) checked @endif
                                id="report_sales_order" name="report_sales_order" class="form-check-input"
                                type="checkbox"> <label class="form-check-label" for="report_sales_order">Sales
                                Order</label> </div>
                        <div class="form-check mt-2"> <input @if (isset($role->report_stock) ? $role->report_stock : false) checked @endif
                                id="report_stock" name="report_stock" class="form-check-input" type="checkbox"> <label
                                class="form-check-label" for="report_stock">Stock</label> </div>
                        <div class="form-check mt-2"> <input @if (isset($role->report_profit_loss) ? $role->report_profit_loss : false) checked @endif
                                id="report_profit_loss" name="report_profit_loss" class="form-check-input"
                                type="checkbox"> <label class="form-check-label"
                                for="report_profit_loss">Profit/Loss</label> </div>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            check_all.addEventListener('click', function() {
                ...
                if (this.checked) {
                    check_parent_role.forEach(function(check) {
                        check.checked = true;
                        var check_child = check.parentElement.parentElement.querySelector(
                            '.check-child');
                        check_child.querySelectorAll('input').forEach(function(child) {
                            child.checked = true;
                        });
        ...
        check_child.forEach(function(check) {
            check.addEventListener('click', function() {
                var check_parent_role = this.parentElement.parentElement.parentElement.querySelector(
                    '.check_parent_role');
                if (this.checked) {
