                ...
                <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                    ...
                    <form  method="post" action="{{route('auth')}}">
                        ...
                        <div class="intro-x mt-8">
                            <input required type="text" name="username" class="intro-x login__input form-control py-3 px-4 block" placeholder="Username" autocomplete="off" autofocus>
                            <input required type="password" name="password" class="intro-x login__input form-control py-3 px-4 block mt-4" placeholder="Password" autocomplete="off">
                        </div>
