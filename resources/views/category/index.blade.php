...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <a href="{{url('/category/create')}}" class="btn btn-primary shadow-md mr-2">Add New {{$title}} </a>
        <div class="dropdown">
            ...
            <tbody>
                ...
                <tr class="intro-x">
                    ...
                    <td>
                        <div class="flex">
                            <i class="{{$item->icon}}"></i>
                            <a  class="font-medium whitespace-nowrap"href="{{route('category.edit',$item)}}"> {{$item->category_name}} </a>
                        </div>
                    </td>
                    <td class="text-center">{{$item->created_at->format('d/m/Y')}}</td>
                    <td class="table-report__action w-56">
                        <div class="flex justify-center items-center">
                            <a class="flex items-center mr-3" href="{{route('category.edit',$item)}}"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
