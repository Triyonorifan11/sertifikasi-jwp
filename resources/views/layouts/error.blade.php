    ...
    <div class="container">
        ...
        <div class="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left">
            ...
            <div class="text-white mt-10 lg:mt-0">
                <div class="intro-x text-8xl font-medium">{{ isset($status_code) ? $status_code : 404  }}</div>
                <div class="intro-x text-xl lg:text-3xl font-medium mt-5">{{isset($title) ? $title : 'Oops. This page has gone missing.'}}</div>
                <div class="intro-x text-lg mt-3">{{isset($messsage) ?  $messsage : 'You may have mistyped the address or the page may have moved.'}}</div>
